...
* protocol: `tfs`
* captured at: `2026-09-16T19:11:27.844304+00:00`
...
* idle unload observed: `True` (101.203s)
...
|---|---|---|---|
| GET | `http://192.168.22.102:28031/v1/broker/metrics` | ConnectionError | ('Connection aborted.', RemoteDisconnected('Remote end closed connection without response')) |
| GET | `http://192.168.22.102:28031/v1/broker/metrics` | ConnectionError | ('Connection aborted.', RemoteDisconnected('Remote end closed connection without response')) |
| GET | `http://192.168.22.102:28031/v1/broker/metrics` | ConnectionError | ('Connection aborted.', RemoteDisconnected('Remote end closed connection without response')) |
| GET | `http://192.168.22.102:28031/v1/broker/metrics` | ConnectionError | ('Connection aborted.', RemoteDisconnected('Remote end closed connection without response')) |
| GET | `http://192.168.22.102:28031/v1/broker/metrics` | ConnectionError | ('Connection aborted.', RemoteDisconnected('Remote end closed connection without response')) |

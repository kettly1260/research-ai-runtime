## Acceptance run — ovms-2026.3.1-kserve-cpu

* gateway: `http://192.168.22.102:28022`
* OVMS: `http://192.168.22.102:28352`
* protocol: `kserve`
* captured at: `2026-09-16T18:53:05.702859+00:00`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 256 | 252 | 200 / 1.25s | 1024 | 1.0 | 200 | 0.703s | 200 |
| 512 | 512 | 200 / 0.813s | 1024 | 1.0 | 200 | 1.531s | 200 |
| 1024 | 1022 | 200 / 2.5s | 1024 | 1.0 | 200 | 4.656s | 200 |
| 4591 | 4592 | 200 / 10.328s | 1024 | 1.0 | 200 | 20.187s | 200 |

### Reranker

* biology score: `0.993563324763129`
* Eiffel score: `3.076311903888812e-05`
...
* idle unload observed: `True` (95.656s)
...
|---|---|---|---|
| GET | `http://192.168.22.102:28022/v1/broker/metrics` | ConnectionError | ('Connection aborted.', RemoteDisconnected('Remote end closed connection without response')) |

### Capability capture — ovms-2026.3.1-kserve-cpu

Captured at `2026-09-16T18:53:06.355999+00:00`, base `http://192.168.22.102:28352`.
